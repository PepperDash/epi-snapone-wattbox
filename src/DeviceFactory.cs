...
namespace Pdu_Wattbox_Epi
{
    public class WattboxFactory : EssentialsPluginDeviceFactory<WattboxController>
    {
        ...
        {
            Debug.LogMessage(LogEventLevel.Debug, "Factory Attempting to create new Wattbox Device");
            ...
            Debug.LogMessage(LogEventLevel.Debug, "Wattbox control method: {0}", controlProperties.Method);
            ...
            {
                Debug.LogMessage(LogEventLevel.Debug, "Creating Wattbox using HTTP Comms");
            ...
            {
                Debug.LogMessage(LogEventLevel.Debug, "Creating Wattbox using TCP/IP Comms");
